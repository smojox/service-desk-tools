...
import { ArrowLeft, User, LogOut, Shield, AlertTriangle } from "lucide-react"
...
export default function PriorityTrackerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-red-500 to-pink-400">
      {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-xl font-semibold">Priority Tracker</span>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
          ...
          <Card className="border-0 bg-white/90 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-gray-900 text-2xl">
                ...
                Priority Tracker Dashboard
              </CardTitle>
              <p className="text-gray-600">
                Manage and track high-priority issues across all clients with integrated ticketing and collaboration features.
              </p>
            </CardHeader>
            <CardContent>
              <PriorityTrackerWidget />
            </CardContent>
          </Card>
        </div>
      </div>
